...
![Outlook — New meeting form with Vauban U1 room selected](images/01_outlook_new_meeting.png)
...
![Poly dock — Meeting visible, tapping Join](images/02_poly_dock_join_meeting.png)
...
![Teams — Share content button in meeting toolbar](images/03_teams_share_screen.png)
...
![TV — HDMI 3 port connected](images/04_tip_tv_hdmi3.png)
...
![Remote control — pointing at the bottom-left LED sensor](images/05_tip_remote_control.png)
...
![Poly — Instant meeting button](images/06_tip_instant_meeting_button.png)
